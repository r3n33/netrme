...
// Disp & Drawing
void DrawIntro(Robot::ArbotixPro *arbotix_pro);
void DrawEnding();
void DrawPage();
...
// Edit value
void UpDownValue(Robot::ArbotixPro *arbotix_pro, int offset);
void SetValue(Robot::ArbotixPro *arbotix_pro, int value);
int GetValue();
void ToggleTorque(Robot::ArbotixPro *arbotix_pro);
int IndexPage(void);
...
void TimeCmd();
void SpeedCmd();
void PlayCmd(Robot::ArbotixPro *arbotix_pro, int pageNum);
void ListCmd();
void OnOffCmd(Robot::ArbotixPro *arbotix_pro, bool on, int num_param, int *list, char lists[30][10]);
...
void NewCmd();
void GoCmd(Robot::ArbotixPro *arbotix_pro, int index);
void SaveCmd(int pageNum);
void NameCmd();
void MonitorServos(Robot::ArbotixPro *arbotix_pro);
